            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav">
                    <?php if(auth()->guard()->check()): ?>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('bookshelves.*') ? 'active' : ''); ?>" href="<?php echo e(route('bookshelves.index')); ?>">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                                <li>
                                    <a class="dropdown-item" href="<?php echo e(route('profiles.show', auth()->user())); ?>">
                    ...
                    <?php else: ?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link btn btn-light text-dark ms-2" href="<?php echo e(route('register')); ?>" style="padding: 0.5rem 1rem !important;">
