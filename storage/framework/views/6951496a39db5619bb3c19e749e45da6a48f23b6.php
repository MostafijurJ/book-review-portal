...
unset($__errorArgs, $__bag); ?>" 
                                  id="synopsis" name="synopsis" rows="5"><?php echo e(old('synopsis')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="url" class="form-control <?php $__errorArgs = ['cover_image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                       id="publication_date" name="publication_date" value="<?php echo e(old('publication_date')); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                       id="page_count" name="page_count" value="<?php echo e(old('page_count')); ?>" min="1">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mr/PhpstormProjects/book-review-portal/resources/views/admin/books/create.blade.php ENDPATH**/ ?>